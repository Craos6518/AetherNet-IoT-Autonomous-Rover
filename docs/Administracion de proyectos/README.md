...
Carpeta canónica para la asignatura **TS683 Administración y Planeación de Proyectos de Software** (UTP).
...
**`Proyecto_AetherNet_Andres_Felipe_Martinez_Henao.docx`** (99 KB, 12 tablas, 671 párrafos, encabezado UTP + pie de página) desarrolla las 14 secciones de la plantilla:
...
7. **Cronograma:** tabla 8 filas + Gantt mermaid (gantt.md) — responsable único en todas las filas.
8. **Riesgos:** 13 riesgos R-01..R-13 (4 cerrados/resueltos, R-02/R-03 críticos) — risk-register.md.
