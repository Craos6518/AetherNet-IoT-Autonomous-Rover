...
- Sprint activo: **Sprint 3 (Semanas 5-6) — En curso (Sprint 2 ✅ CERRADO documental 2026-09-10, Sprint 1 ✅ 2026-09-01) — MOV-05/06 ✅ Done + TCRT/HC-SR04 ✅ Done**
- Rama activa: **`feature/app-joystick-virtual@e821700`** — Joystick nRF24 + TCRT invertido + HC-SR04 EMA + `docs/Firmware/notebook/Firmware_Notebook.ipynb` + `docs/logs/firmware_sprint3/live_2026-09-11/T_telemetry_invertida.log`; base `docs/revision-sprint2-completa@ec5d70b`
- Última actualización: **2026-09-11 — Sprint 3 MOV-05/06 ✅ + calce Rover + sensores ✅ + telemetría**
