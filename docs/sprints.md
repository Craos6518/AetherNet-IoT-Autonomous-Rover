...
- Rama activa: **`feature/app-joystick-virtual@e821700`** — Joystick nRF24 + TCRT invertido + HC-SR04 EMA + `notebooks/Firmware_Notebook.ipynb` + `docs/logs/firmware_sprint3/live_2026-09-11/T_telemetry_invertida.log`; base `docs/revision-sprint2-completa@ec5d70b`
