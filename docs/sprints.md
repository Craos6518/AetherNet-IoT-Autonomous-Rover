...
- Última actualización: **2026-08-31 — Sprint 1 cerrado 2026-08-26 + Deuda 8/8 + sinceramiento + rotación + LOW-01 pivot** (ver `docs/deuda-sprint1-sprint2.md:36`); `develop` al día con `a051dd4` EMA bench 531 + `f1ffcaa` stats
...
- Deuda Sprint 1→2 saldada 2026-08-29 (8/8) — deltas 2026-08-31:
  ...
  - [~] MOV-01/MOV-12: `docs/cierre-mov01.md:4` ⚠️ plantilla-only 2026-08-31 (0 líneas propias, scaffold wizard) + `app/build.gradle.kts:4` KSP 1.9.22-1.0.17 + `app/gradlew` 9.5.0 `tasks` OK — infra verde, lógica queda para Sprint 2
